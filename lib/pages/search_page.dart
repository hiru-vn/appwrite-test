...
class _SearchPageState extends State<SearchPage> {
  ...
  List<Map<String, dynamic>> searchSnapshot = [];
  ...
  initiateSearchMethod() async {
    if (searchController.text.isNotEmpty) {
      ...
      await DatabaseService()
          ...
          .then((snapshot) {
        setState(() {
          searchSnapshot = snapshot.documents.map((e) => e.data).toList();
          isLoading = false;
  ...
  Widget groupTile(
    ...
    return ListTile(
      ...
      trailing: InkWell(
        onTap: () async {
          await DatabaseService().toggleGroupJoin(groupId, userName, groupName);
          if (isJoined) {
            setState(() {
              isJoined = !isJoined;
            });
